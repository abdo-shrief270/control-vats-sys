...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/car_status.css')}}">
</head>
<body class="d-flex flex-column min-vh-100">
            ...
            <div class="offcanvas offcanvas-end  w-75 side-bar" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a id="statusPageLink" class="nav-link text-dark pl-xl-3 fs-5 a-font" aria-current="page"
    ...
    <div class="container d-flex flex-column gap-3">
        ...
        <div class="row justify-content-around p-2 gap-2">
            <strong class="fs-2 text-center">Last Location Data</strong>
            <div class="col-md-3 bg-primary bg-opacity-25 border border-1 border-primary bg-primary rounded-4 d-flex flex-column justify-content-center align-items-center gap-1">
                <strong class="fs-4">latitude</strong>
                <p class="fs-5" id="latitude"></p>
            </div>
            <div class="col-md-3 bg-primary bg-opacity-25 border border-1 border-primary bg-primary rounded-4 d-flex flex-column justify-content-center align-items-center gap-1">
                <strong class="fs-4">Longitude</strong>
                <p class="fs-5" id="Longitude"></p>
            </div>
            <div class="col-md-3 bg-primary bg-opacity-25 border border-1 border-primary bg-primary rounded-4 d-flex flex-column justify-content-center align-items-center gap-1">
                <strong class="fs-4">altitude</strong>
                <p class="fs-5" id="altitude"></p>
            </div>
        </div>
        <div class="row justify-content-around p-2 gap-2">
            <div class="col-md-3 bg-info bg-opacity-25 border border-1 border-info bg-info rounded-4 d-flex flex-column justify-content-center align-items-center gap-1">
                <strong class="fs-4">X</strong>
                <p class="x fs-5"></p>
            </div>
            <div class="col-md-3 bg-info bg-opacity-25 border border-1 border-info bg-info rounded-4 d-flex flex-column justify-content-center align-items-center gap-1">
                <strong class="fs-4">Y</strong>
                <p class="y fs-5"></p>
            </div>
            <div class="col-md-3 bg-info bg-opacity-25 border border-1 border-info bg-info rounded-4 d-flex flex-column justify-content-center align-items-center gap-1">
                <strong class="fs-4">Z</strong>
                <p class="z fs-5"></p>
            </div>
        </div>
    </div>
    ...
    <script src="{{asset('assets/car_status.js')}}"></script>
