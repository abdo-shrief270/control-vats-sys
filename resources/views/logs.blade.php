...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/logs.css')}}">
</head>
<body class="d-flex flex-column min-vh-100 vh-100 ">
    ...
    <nav class="navbar navbar-expand-xl bg-white">
        ...
        <div id="viewLogs" class="container vw-100 h-75 overflow-auto">
            <div id="viewLogsDiv" class="d-flex flex-column-reverse justify-content-center align-items-center gap-2 align-content-end"></div>
        </div>
    <div class="mt-auto">
    ...
    <script src="{{asset('assets/logs.js')}}"></script>
