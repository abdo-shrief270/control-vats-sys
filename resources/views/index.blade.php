    ...
    <div class="container-fluid w-100 text-center d-flex justify-content-center">
        <div class="row w-100 ">
            <div class="col-12 col-sm-12 col-md-12 col-lg-8 text-center d-flex justify-content-center">
                <div id="mapDiv" class="border rounded-3" style="width: 100vw;"></div>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 text-center">
                <div class="row" style="position: relative;">
                    <div class="col-12">
                        <button class="btn btn-success w-100 fs-3 mt-3 py-3" style="display: none;" id="install">Install App</button>
                    </div>
                    <div class="col-12">
